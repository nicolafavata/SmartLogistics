...
class NewCompany extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'email_company' => 'required|string|email|max:255|unique:company_offices,email_company',
    ...
    public function messages()
    {
        return [
            ...
            'email_company.unique'  => 'Esiste un\'altra sede con la stessa email inserita',
