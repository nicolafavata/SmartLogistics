                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active" style="no-repeat center center;">
                                    <img class="d-block w-100" src="img/trova_prodotti.jpg" alt="Viaggio in auto">
                                ...
                                <div class="carousel-item" style="no-repeat center center;">
                                    <img class="d-block w-100" src="img/monitoraggio_magazzino.jpg" alt="Viaggi fra sole donne">
                                    <div class="carousel-caption d-none d-md-block animated bounceInDown">
                                ...
                                <div class="carousel-item" style="no-repeat center center;">
                                    <img class="d-block w-100" src="img/ordini_ottimizzati.jpg" alt="Viaggi fra sole donne">
                                    <div class="carousel-caption d-none d-md-block animated bounceInDown">
                                ...
                                <div class="carousel-item" style="no-repeat center center;">
                                    <img class="d-block w-100" src="img/ricezione_automatica_degli_ordini.jpg" alt="Viaggi fra sole donne">
                                    <div class="carousel-caption d-none d-md-block animated bounceInDown">
                                ...
                                <div class="carousel-item" style="no-repeat center center;">
                                    <img class="d-block w-100" src="img/supply_chain.jpg" alt="Viaggia con il tuo amichetto">
                                    <div class="carousel-caption d-none d-md-block animated bounceInDown">
