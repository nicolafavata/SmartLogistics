                        ...
                        @forelse($item as $found)
                            <tr>
                                ...
                                <td class="font-weight-bold text-dark text-capitalize">
                                    <?php $imp = round($found->total_sales_invoice,2)?>
                                    {{$imp.' €'}}
                                </td>
                                ...
                                <td class="font-weight-bold text-center text-dark text-center"><i title="Elimina la fattura n: {{$found->number_sales_invoice}}" class="fucsia fa fa-trash-o fa-1x"></i></a></td>
                            </tr>
                                                        ...
                                                        @if($comp->invoice_salesInvCon==$found->id_sales_invoice)
                                                            <tr>
                                                                <?php
                                                                    ...
                                                                    $iva = $iva + $iva_unit;
                                                                    $price = round($price,2);
                                                                    $quantity = round($comp->quantity_salesInvCon,2);
