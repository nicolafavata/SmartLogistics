...
<html lang="en" class="no-js">
	...
	<body onload="hideloader()">
		<div class="container">
			<div class="menu-wrap">
				<nav class="menu-top">
					<div class="profile"><img class="border-border-verde" src="img/profile.jpg" width="50" height="50" alt="{{$dati->name.' '.$dati->cognome}}"/><span>{{$dati->name.' '.$dati->cognome}}</span></div>
					<div class="icon-list">
					...
					<ul id="menu_a_2livelli">
						...
						<li>
							...
							<ul>
								...
								<li><a href="#">Associazione prodotti</a></li>
							</ul>
						</li>
							@endif
							@if($dati->vendite=='1')
