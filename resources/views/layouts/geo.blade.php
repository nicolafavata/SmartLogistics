        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" style="color: white;" href="{{ route('user') }}">La mia Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" style="color: white;" href="viaggio.php">Cerca un prodotto</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" style="color: white;" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        Servizi
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="{{ route('completeuser') }}">Il mio account</a>
                        <a class="dropdown-item" href="viaggio.php">Cerca un prodotto</a>
                        <a class="dropdown-item" href="ricerca.php">Cerca un negozio</a>
                        <a class="dropdown-item" href="viaggiconducente.php">Il mio carrello</a>
                        <a class="dropdown-item" href="viaggipasseggero.php">I miei ordini</a>
