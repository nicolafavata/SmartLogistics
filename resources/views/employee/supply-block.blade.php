...
@section('content')
    <div class="carousel-inner request-supply_img">
        ...
        <div class="container admin_home">
            <div class="row">
                <div class="row">
                    <h1 class="fucsia font-weight-bold shadow uppercase">Le aziende bloccate</h1>
                </div>
                ...
                <div class="col-md-12 jumbotron border">
                    @forelse($company as $found)
                            ...
                            <div class="row">
                                    <form onsubmit="showloader()" method="POST" action="{{ route('sblock-company', $found->company_requested) }}">
                                        {{ csrf_field() }}
                                        <button type="submit" class="btn btn-primary2">Sblocca</button>
                                    </form>
                            </div>
                            <hr>
                    @empty
